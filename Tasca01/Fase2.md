...
| :---- | :---- | :---- |
| **Dades Crítiques** | Per exemple: Bases de dades de clients, factures, inventari, registres legals | Són dades que, si es perden, afectarien greument l’operativa i la seguretat legal i financera de l’empresa. |
...
| **Tipus de Còpia (BD)** | Completa amb incremental | Una còpia completa setmanal \+ còpies incrementals diàries permet optimitzar espai i recuperar ràpidament la informació. |
...
* **2 mitjans diferents:** Evitar dependència d’un sol tipus de dispositiu.  
* **1 fora de lloc:** Garantir recuperació en cas de desastres locals.
